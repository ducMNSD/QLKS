...
<head>
	<meta charset="utf-8">
    <title>Sửa khách hàng | qlks.bk</title>
...
<body>
	...
	<div class="container">
		<div class="themkh-menu">
			<center>
				<h2 class="title">Form sửa khách hàng</h2>
	...
	<?php
		...
		if(isset($_POST['hoantat'])){
			if ($hoten == '' || $diachi == '' || $cmnd == '' || $sdt == '' || $gioitinh == '' || $quoctich == '') {
				...
				$sql = "update khachhang set hoten = '$hoten', diachi = '$diachi', cmnd = '$cmnd', tel = '$sdt', gioitinh = '$gioitinh', quoctich = '$quoctich' where makh = $makh";
