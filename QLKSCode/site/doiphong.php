...
<head>
	<meta charset="utf-8">
	<title>Đổi phòng | qlks.bk</title>
    <meta name="description" content="">
    <link rel="stylesheet" type="text/css" href="../CSS/changeroom.css">
	...
	<div class="content">
		<div class="login-box">
			<form class="login-form" method="POST">
				<div>Ngày đổi: <input type="text" name="ngayden" placeholder="VD: 2018-12-01"></div>
		...
		?>
		<div>
			<center><h2 class="ten">Danh sách phòng còn trống</h2></center>
				...
				<table  width="1200" border="1" style="border-collapse: collapse;"> 
			        ...
			        <tbody>
			        	...
			        	<tr style="text-align: center; height: 30px;">
			                ...
			                <td><a href="../site/formdoiphong.php?ID=<?php echo $row['map']; ?>" style="text-decoration: none; color: #317fbd;">Đổi</a></td>
