...
<head>
	<meta charset="utf-8">
	<title>Form cập nhật ngày đi | qlks.bk</title>
...
<body>
	...
	<div class="content">
		<div class="login-box">
			<h2 class="title">Form cập nhật ngày đi</h2>
				...
				<div id="line-btn" class="line btnline">
					...
					<?php
						...
						if (isset($_POST['hoantat'])) {
							...
							if ($makh == '' || $ngayden == '' || $ngaydi == '' || $map == '') {
								echo "Vui lòng nhập đầy đủ thông tin";
							}else{
								$sql = "select update_datphong($makh, '$map', '$ngayden', '$ngaydi')";
